import {
  ...
  NestedmenuIcon,
  Erroricon,
} from "/shared/layouts-components/sidebar/nav"; // importa le tue icone da un file separato

// MENU COMPLETO COPRAL
export const MENUITEMS_COPRAL = [
  { menutitle: "MAIN" },
...
export const FILTERED_MENU_COPRAL = filterMenu(MENUITEMS_COPRAL);
